...
export default [<Route key="1" path={'/'} component={App}/>,
                ...
                <Route key="6" path={'/markavailability'} render={(props) => <MarkAvailability monthMap={monthMap} currentMonth={currentMonth} saveDays={passedDays} selectDay={selectDayPass} />} />,
                <Route key="7" path={'/decidedate'} render={(props) => <DecideDate monthMap={monthMap} currentMonth={currentMonth} saveDays={saveDays} passedDays={passedDays} selectDay={selectDaySave} />} />,
