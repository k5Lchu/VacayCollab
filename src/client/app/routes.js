...
export default [<Route key="1" path={'/'} component={App}/>,
                ...
                <Route key="6" path={'/markavailability'} render={(props) => <MarkAvailability monthMap={monthMap} currentMonth={currentMonth} months={months} daysInWeek={daysInWeek} saveDays={passedDays} selectDay={selectDayPass} />} />,
